...
function update(customerId){
	window.location.href="customer/prepareUpdate.do?customerId="+customerId;
}
</script>
<body>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i> 客户
								</h2>
							</div>
							<div style="margin: 20px 10px">
								<form id="searchForm" method="post" action="customer/customerSearch.do">
							...
							<div class="box-content">
									...
									<tbody>
										<c:forEach items="${list}" var="item" varStatus="index">
											<tr>
												...
												<td class="center">${item.cSex}</td>
												<td class="center">${item.cEmail}</td>
												<td class="center">${item.cPhone}</td>
												<td class="center">
													<button type="button" class="btn btn-purple btn-sm" onclick="update('${item.customerId}')">
														修改
													</button>
												</td>
											</tr>
								...
								<form method="post" id="pageForm" action="customer/customerSearch.do">
