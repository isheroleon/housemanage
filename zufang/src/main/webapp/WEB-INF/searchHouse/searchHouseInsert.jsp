					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-content">
								<form method="post" action="searchHouse/searchHouseInsert.do">
									<div class="input-group col-md-4">
										<label>地址</label> 
										<input type="text" class="form-control" id="sAddress" name="sAddress"  value="${sAddress}">
									</div>
									<div class="input-group col-md-4">
										<label>联系人</label> 
