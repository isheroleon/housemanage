...
INSERT INTO `t_permission` VALUES ('8', 'wantManger', '1', '/want/wantSearch.do', '求租信息管理', '6', '1');
INSERT INTO `t_permission` VALUES ('9', null, '1', null, '新闻管理', '0', '0');
INSERT INTO `t_permission` VALUES ('10', 'newsManger', '1', '/news/newsSearch.do', '新闻信息管理', '9', '1');
INSERT INTO `t_permission` VALUES ('11', 'newsInsert', '1', '/news/prepareInsert.do', '添加新闻信息', '16', '1');
INSERT INTO `t_permission` VALUES ('12', 'wantInsert', '1', '/want/prepareInsert.do', '添加求租信息', '16', '1');
INSERT INTO `t_permission` VALUES ('13', 'employeeInsert', '1', '/employee/prepareInsert.do', '添加员工信息', '16', '1');
INSERT INTO `t_permission` VALUES ('14', 'customerInsert', '1', '/customer/prepareInsert.do', '添加客户信息', '16', '1');
...
INSERT INTO `t_permission` VALUES ('18', 'searchHouseManger', '1', '/searchHouse/searchHouseSearch.do', '个人寻房', '15', '1');
INSERT INTO `t_permission` VALUES ('19', 'sellHouseInsert', '1', '/sellHouse/prepareInsert.do', '添加售房', '16', '1');
INSERT INTO `t_permission` VALUES ('20', 'searchHouseInsert', '1', '/searchHouse/prepareInsert.do', '添加个人寻房', '16', '1');
INSERT INTO `t_permission` VALUES ('21', 'tenementInsert', '1', '/tenement/prepareInsert.do', '添加出租房', '16', '1');
INSERT INTO `t_permission` VALUES ('22', 'buildInsert', '1', '/build/prepareInsert.do', '添加楼盘', '16', '1');
